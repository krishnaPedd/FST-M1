...
public class Activity17 {
    public static void main(String[] args) {
        ...
        System.out.println("Selected Second option is: " + singleSelect.getFirstSelectedOption().getText());

        // Select the third option using index
        singleSelect.selectByIndex(3);
        // Print the selected option
        System.out.println("Selected Third option is : " + singleSelect.getFirstSelectedOption().getText());

        // Select the fourth option using value attribute
        singleSelect.selectByValue("4");
        // Print the selected option
        System.out.println("Selected Fourth option: " + singleSelect.getFirstSelectedOption().getText());
